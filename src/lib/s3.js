...
async function generatePresignedUrl(fileName, fileType) {
  ...
  // Compute public URL (assuming public access is enabled on the bucket or via custom domain)
  // We'll require a public domain environment variable if needed, or format a raw url
  // Note: Raw R2 URLs usually require a custom domain or r2.dev domain for public access
